	...
	$(document).ready(function(){
		...
		function update(){
			...
			if(game.playerTime < 0){
				...
				game.bgContext.fillText('Time up!', game.width/2-50,game.height/2-50);
				game.speed = 0;
		...
		function verifyUploadOfAllImages(int1,type1,int2,type2){
